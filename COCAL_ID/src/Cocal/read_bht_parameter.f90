! 
subroutine COCAL_ID_read_bht_parameter_cactus(dir_path)

use COCAL_ID_phys_constant, only : long, pi
use COCAL_ID_grid_parameter, only : r_surf, num_sol_seq
use COCAL_ID_def_bh_parameter
use COCAL_ID_def_bht_parameter
implicit none
...
!
end subroutine COCAL_ID_read_bht_parameter_cactus
